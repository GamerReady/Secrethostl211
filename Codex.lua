local Alysse = loadstring(game:HttpGet("https://raw.githubusercontent.com/NathTheDev/Alysse-KavoUI/main/KavoUI"))()
local AlysseWindow = Alysse.CreateLib("Alysse Script Hub : v0.3", "PurpleTheme")

_G.AlysseLoaded = true

makefolder("Alysse Workspace")
if not isfile("iconshape") then
	writefile("iconshape", "Default")
end

if not isfile("AlysseConfig.txt") then
	writefile("AlysseConfig.txt", "Version : 0.3")
end
...
G2L["1e"]["Image"] = [[rbxassetid://14334029762]];
G2L["1e"]["Size"] = UDim2.new(0, 45, 0, 45)
G2L["1e"]["Name"] = [[Toggle]];
G2L["1e"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["1e"]["Visible"] = true;
G2L["1e"].Draggable = true
G2L["1e"]["Position"] = UDim2.new(0.4557916224002838, 0, 0.018518516793847084, 0);
...
G2L["1d"].Color = Color3.fromRGB(204, 0, 204)
...
local AlysseHome = AlysseWindow:NewTab("Home")
local AlysseHomeButton = AlysseHome:NewSection("Information")

local AlysseTab = AlysseWindow:NewTab("Scripts")
local AlysseSection = AlysseTab:NewSection("Scripts")

local AlysseUniversal = AlysseWindow:NewTab("Universal")
local AlysseUniversalSection = AlysseUniversal:NewSection("Universal Scripts")

local AlysseGames = AlysseWindow:NewTab("Games")
local AlysseDahoodSection = AlysseGames:NewSection("Da Hood")

local AlysseAdmin = AlysseWindow:NewTab("Admin")
local AlysseAdminSection = AlysseAdmin:NewSection("Admin Scripts")

local AlysseBuiltIn = AlysseWindow:NewTab("Executor")
local AlysseBuiltInSection = AlysseBuiltIn:NewSection("Executor")

local AlysseHub = AlysseWindow:NewTab("Random Hub")
local AlysseRandomHub = AlysseHub:NewSection("Random Hub")

local AboutAlysse = AlysseWindow:NewTab("About Us")
local AlysseInformation = AboutAlysse:NewSection("About Alysse")

local AlysseUpdate = AlysseWindow:NewTab("Update Log's")
local AlysseUpdateSection = AlysseUpdate:NewSection("What's New?")
...
AlysseSection:NewDropdown("Change FPS Cap", "Change the FPS cap for a smoother experience", {"60 FPS", "120 FPS", "Max FPS"}, function(selection)
	fpsc = selection
end)

AlysseSection:NewButton("Set FPS Cap", "", function()
	if fpsc == "60 FPS" then
		setfpscap(60)
	elseif fpsc == "120 FPS" then
		setfpscap(120)
	elseif fpsc == "Max FPS" then
		setfpscap(0)
	end
end)

AlysseSection:NewLabel("Server")

AlysseSection:NewDropdown("Server Configure", "", {"Rejoin", "ServerHop", "LowServer"}, function(server)
	if server == "Rejoin" then
		game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
	elseif server == "ServerHop" then
...
AlysseSection:NewButton("Kick yourself", "", function()
	game.Players.LocalPlayer:Kick("\n why did you kick yourself?!")
end)

AlysseSection:NewButton("Fullbright", "", function()
...
local AlyssePlayerSection = AlysseTab:NewSection("LocalPlayer")

AlyssePlayerSection:NewTextBox("Input WalkSpeed Value", "Add WalkSpeed", function(ws)
	walk = ws
end)

AlyssePlayerSection:NewToggle("Enable WalkSpeed", "Increase WalkSpeed", function(toggle)
	if toggle then
...
AlyssePlayerSection:NewTextBox("Input JumpPower Value", "Add JumpPower", function(jp)
	jump = jp
end)

AlyssePlayerSection:NewToggle("Enable JumpPower", "Increase JumpPower", function(lol)
	if lol then
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = walk
	else
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = 50
	end
end)

AlyssePlayerSection:NewButton("Expand Hitbox", "", function()
	_G.HeadSize = 25
	_G.Disabled = true
...
AlyssePlayerSection:NewButton("TP Tool", "", function()
...
AlyssePlayerSection:NewButton("Fly V3", "Suitable for mobile", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/w3Bs9rHN"))()
end)

AlyssePlayerSection:NewButton("Arceus Fly", "Suitable for mobile", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/AZYsGithub/chillz-workshop/main/Arceus%20Fly.lua"))()
end)

AlyssePlayerSection:NewButton("Infinite Jump", "", function()
...
AlyssePlayerSection:NewToggle("Noclip", "phase through walls", function(clip)
...
AlyssePlayerSection:NewButton("[ NOT WORKING ] Anti-Fling", "", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/PuAwMhXK"))()
end)

AlysseBloxFruitSection = AlysseGames:NewSection("Blox Fruits")

AlysseBloxFruitSection:NewButton("Zen Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ZenHubTheBest/Main/main/Loader", true))()
end)

AlysseBloxFruitSection:NewButton("Hirimi V2", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Hirimii/Hubv2/main/Hirimiv2.lua"))()
end)

AlysseBloxFruitSection:NewButton("MTRIET Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Minhtriettt/Free-Script/main/MTriet-Hub.lua"))()
end)

AlysseBloxFruitSection:NewButton("Qwerty Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/PNguyen0199/Qwerty-Hub/main/Qwerty-Hub.lua"))()
end)

AlysseBloxFruitSection:NewButton("Grinding Hub", "", function()
...
AlysseBrookhavenSection = AlysseGames:NewSection("Brookhaven")

AlysseBrookhavenSection:NewButton("Ice Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/IceMael7/NewIceHub/main/Brookhaven"))()
end)

AlysseDahoodSection:NewButton("Artic", "", function()
	loadstring(game:HttpGet("https://polarsblade.xyz/Arctic/Arctic.txt"))()
end)

AlysseDahoodSection:NewButton("Pluto", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/Scrvpter/Pluto/Lua/Loader.Lua', true))()
end)

AlysseDahoodSection:NewButton("SwagMode", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/lerkermer/lua-projects/master/SwagModeV002'))()
end)

AlysseDahoodSection:NewButton("RayCodex", "", function()
	loadstring(game:GetObjects("rbxassetid://5812737894")[1].Source)()
end)

AlysseDahoodSection:NewButton("Faded ( Outdated )", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/NighterEpic/Faded-Grid/main/YesEpic", true))()
end)

AlysseDahoodSection:NewButton("Mobile Aimlock", "", function()
...
AlysseDahoodSection:NewButton("Da Hood Script 7", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/SpaceYes/Lua/Main/DaHood.Lua'))()
end)

AlysseDahoodSection:NewButton("Macro Speed", "", function()
	getgenv().Speed = true
	getgenv().FakeMacro = false
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Allvideo/nukermode/main/Kit%20tools.txt"))()
end)

local AlysseHoopzSection = AlysseGames:NewSection("Hoopz")

AlysseHoopzSection:NewButton("Hoopz Aimbot", "", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/KA4DPct8"))() 
end)

AlysseHoopzSection:NewButton("ToraIsMe Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0strongman"))() 
end)

local AlysseBedwarsSection = AlysseGames:NewSection("Bedwars")

AlysseBedwarsSection:NewButton("Vape V4", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/7GrandDadPGN/VapeV4ForRoblox/main/NewMainScript.lua", true))()
end)

AlysseBedwarsSection:NewButton("Ape V1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/lightHubDev/Ape/main/ApeMain"))()
end)

AlysseBedwarsSection:NewButton("Darkrai X", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/GamingScripter/bedwars/main/Script", true))()
end)

AlysseMM2Section =AlysseGames:NewSection("MM2")

AlysseMM2Section:NewButton("Random MM2 Hub", "", function()
	loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Drifter0507/GUIS/main/MURDER%20MYSTERY%202", true))();
end)

AlysseMM2Section:NewButton("Random MM2 Hub 2", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Drifter0507/scripts/main/mm2", true))()
end)

AlysseMM2Section:NewButton("Vynixu", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Neon-Fox/roblox-scripts/main/VynixuMM2"))()
end)

AlysseMM2Section:NewButton("MM2 Admin", "", function()
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/MarsQQ/ScriptHubScripts/master/MM2%20Admin%20Panel'),true))()
end)

AlysseBPSection =AlysseGames:NewSection("Breaking Point")

AlysseBPSection:NewButton("Breaking Point 1", "", function()
	getgenv().AutoFarm = true
	loadstring(game:HttpGet('https://raw.githubusercontent.com/1201for/littlegui/main/Breaking-Point'))()
end)

AlysseBPSection:NewButton("Breaking Point 2", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/H4R7NHacks/Obfuscated/master/Breaking%20Point%20H4R7N%20Hack.lua"))()
end)

AlysseAWSSection = AlysseGames:NewSection("Arm Wrestling Simulator")

AlysseAWSSection:NewButton("LDS Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/limaspeedy/limaspeedy/main/HubLDS"))()
end)

AlysseAWSSection:NewButton("Arm Wrestling Simulator Script 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Emporate/arm-wrestle-script-3/main/EMPORATE"))()
end)

AlysseCarSection = AlysseGames:NewSection("Car Dealership Tycoon")

AlysseCarSection:NewButton("Car Dealership 1", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/weiny-ez/Weinz_Car-Dealership/main/weinz_cars.lua'))()
end)

AlysseSBoxingSection = AlysseGames:NewSection("Shadow Boxing")

AlysseSBoxingSection:NewButton("Shadow Boxing 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/1f0yt/community/main/ShadowBoxing"))()
end)

AlysseSBoxingSection:NewButton("Shadow Boxing 2", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/xtrey10x/xtrey10x-hub/main/shadow"))()
end)

AlysseProjectSlayerSection = AlysseGames:NewSection("Project Slayer")

AlysseProjectSlayerSection:NewButton("Void Hub", "", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/ddCNnaG8"))()
end)

AlyssePrisonLifeSection = AlysseGames:NewSection("Prison Life")

AlyssePrisonLifeSection:NewButton("Tiger Admin", "", function()
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/h17s3/TIGERADMIN/main/TIGERADMINSCRIPTFREE'),true))()
end)

AlysseNinjaLegendsSection = AlysseGames:NewSection("Ninja Legends")

AlysseNinjaLegendsSection:NewButton("Ninja Legends Script 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptpastebin/raw/main/requiem"))()
end)

AlysseRoGhoulSection = AlysseGames:NewSection("Ro-Ghoul")

AlysseRoGhoulSection:NewButton("Ro-Ghoul Script 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/xQuartyx/DonateMe/main/ScriptLoader"))()
end)

AlysseDemonFallSection = AlysseGames:NewSection("Demon Fall")

AlysseDemonFallSection:NewButton("Noob Hub", "", function()
	loadstring(game:HttpGet(('https://raw.githubusercontent.com/NOOBHUBX/DemonFall/main/NOOB%20HUB.Lua'),true))()
end)

AlysseSwordWarriorsSection = AlysseGames:NewSection("Sword Warriors")

AlysseSwordWarriorsSection:NewButton("ToraIsMe Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ToraIsMe/ToraIsMe/main/0swordwarrior"))()
end)

AlysseAnimeFighterSection = AlysseGames:NewSection("Anime Fighters Simulator")

AlysseAnimeFighterSection:NewButton("Platinum Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ZaRdoOx/Loader/main/PlatiniumLoader"))()
end)

AlysseAnimeFighterSection:NewButton("Yuto V2", "", function()
	repeat wait() until game:IsLoaded()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Binintrozza/yutv2e/main/afss"))()
end)

AlysseDoorsSection = AlysseGames:NewSection("Doors")

AlysseDoorsSection:NewButton("Doors Script 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptpastebin/raw/main/InstantSkipRoom"))()
end) 

AlysseDoorsSection:NewButton("Doors Script 2", "", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/R8QMbhzv"))()
end)

AlysseDoorsSection:NewButton("Cloud Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/BadScripters/CloudHub/main/hub"))()
end)

AlysseDoorsSection:NewButton("Black King", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/KINGHUB01/BlackKing/main/BlackKing"))()
end)

AlysseDoorsSection:NewButton("Project WD", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Muhammad6196/Project-WD/main/Mainstring.lua"))()
end)

AlysseDoorsSection:NewButton("Entity Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/plamen6789/DoorsEntitySummonerGUI/main/EntityGUI"))()
end)

AlysseEvadeSection = AlysseGames:NewSection("Evade")

AlysseEvadeSection:NewButton("Evade Script 1", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/zReal-King/Evade/main/Main.lua'))()
end)

AlysseRCSection = AlysseGames:NewSection("Race Clicker")

AlysseRCSection:NewButton("Race Clicker Script 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/boomcacas/androminome/main/hub"))()
end)

AlysseDBSection = AlysseGames:NewSection("Dragon Blox")

AlysseDBSection:NewButton("Dragon Blox Script 1", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Skrapisismyscript/PinPointHub/main/Gamer%20moments"))()
end)

AlysseDBSection:NewButton("Dragon Blox Script 2", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/SenseiJoshy/CastAways/main/Open%20Source/Dragon%20Blox"))()
end)

AlysseSlapBattlesSection = AlysseGames:NewSection("Slap Battles")

AlysseSlapBattlesSection:NewButton("Slap Battles Script 1", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/TheScriptMaster1/ScriptMaster-Hub/main/scriptmasterhub.lua'))()
end)

AlysseTOHSection = AlysseGames:NewSection("Tower of Hell")

AlysseTOHSection:NewButton("Garfield Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/2dgeneralspam1/scripts-and-stuff/master/scripts/garfield%20hub", true))()
end)

AlysseArsenalSection = AlysseGames:NewSection("Arsenal")

AlysseArsenalSection:NewButton("Dex Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/HonestlyDex/DexHub/main/V3.lua"))()
end)

AlysseArsenalSection:NewButton("Darkrai X", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/GamingScripter/arsenal-hub/main/Arsenal%20GamingScripter", true))()
end)

AlysseArsenalSection:NewButton("Thunder Client", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Vcsk/AstralHub/main/Main.lua"))()
end)

AlysseArsenalSection:NewButton("Furk Ultra", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/FurkUltra/UltraScripts/main/arsenal"))()
end)

AlysseArsenalSection:NewButton("Strike Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ccxmIcal/cracks/main/strikehub.lua"))()
end)

AlysseB2Section = AlysseGames:NewSection("Break In 2")

AlysseB2Section:NewButton("JN HH Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/1f0yt/community/main/Circle"))()
end)
AlysseB2Section:NewButton("Breaking Blitz", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/RScriptz/RobloxScripts/main/BreakIn2.lua"))()
end)
AlysseB2Section:NewButton("IceWare", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/nxtcapi/IceWare/main/loader.lua",true))()
end)
AlysseB2Section:NewButton("Proxima Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/TrixAde/Proxima-Hub/main/Main.lua"))()
end)

AlysseBloxburgSection = AlysseGames:NewSection("Bloxburg")

AlysseBloxburgSection:NewButton("Bloxburg Script 1", "", function()
	loadstring(game:HttpGet("https://bsecorporation.net/AtlasInnovation/Scripts/free_script_main.txt"))()
end)

AlysseBladeSection = AlysseGames:NewSection("Blade Ball")

AlysseBladeSection:NewButton("Nereid Hub", "", function()
	loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/b964c4456aeff691784ffaaa181ab423.lua"))()
end)

AlysseBladeSection:NewButton("Nexus Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/s-o-a-b/nexus/main/loadstring"))()
end)

AlysseBladeSection:NewButton("Zap Hub", "", function()
	loadstring(game:HttpGet("https://itots.tk/zaphub/ZapHubFreeVersion"))()
end)

AlysseBladeSection:NewButton("Auto Parry", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/LOLking123456/Blade/main/Ball"))()
end)

AlysseBladeSection:NewButton("Beldo Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/3345-c-a-t-s-u-s/-beta-/main/AutoParry.lua"))()
end)

AlysseAdminSection:NewButton("Infinite Yield", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

AlysseAdminSection:NewButton("[DELTA] Infinite Yield Mobile", "", function()
...
AlysseAdminSection:NewButton("Reviz Admin", "", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/Caniwq2N"))()
end)

AlysseAdminSection:NewButton("Fates Admin", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/fatesc/fates-admin/main/main.lua"))();
end)

AlysseAdminSection:NewButton("Simple Spy", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/infyiff/backup/main/SimpleSpyV3/main.lua"))()
end)

AlysseAdminSection:NewButton("Dex Explorer", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/infyiff/backup/main/dex.lua"))()
end)

AlysseRandomHub:NewButton("Astral Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Vcsk/AstralHub/main/Main.lua", true))()
end)

AlysseRandomHub:NewButton("NukeVsCity", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/NukeVsCity/TheALLHACKLoader/main/NukeLoader", true))()
end)

AlysseRandomHub:NewButton("V.G Hub", "", function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/1201for/V.G-Hub/main/V.Ghub'))()
end)

AlysseRandomHub:NewButton("Inferno V3", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/OWJBWKQLAISH/Inferno-X/main/INFERNO%20X%20VANCE"))()
end)

AlysseRandomHub:NewButton("Lightzone V2", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/ImJosh66/Idjrf5/main/Protected_3590052699937668.lua.txt"))()
end)

AlysseRandomHub:NewButton("Pissware", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/AnAvaragelilmemer/Pissware/main/Main/MobileMain.lua"))()
end)

AlysseRandomHub:NewButton("Chaddest Cat Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Yopapa699/Main/main/MainLoader.lua"))()
end)

AlysseRandomHub:NewButton("GigaChad Hub V5", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/OWJBWKQLAISH/Private-Use-Scripts-/main/Gigachad%20Hub%20V5%20Beta"))()
end)

AlysseRandomHub:NewButton("GigaChad Hub V7", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/LolPrivate/Side/main/Gigachad%20Hub%20V7.lua", true))()
end)

AlysseRandomHub:NewButton("Orange X V5", "", function()
...
AlysseRandomHub:NewButton("Psy Hub", "", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/JwGf73hp"))()
end)

AlysseRandomHub:NewButton("Game Hub V4", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/GamerScripter/Game-Hub/main/loader"))()

end)

AlysseRandomHub:NewButton("Auratus X", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/RealMrQuacks/AuratusX/master/Load"))()
end)

AlysseRandomHub:NewButton("MultiScripter Hub X V3", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/GamerScripter/Multi-Scripter-X/main/loader"))()
end)

AlysseRandomHub:NewButton("Pendulum Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Tescalus/Pendulum-Hubs-Source/main/Pendulum%20Hub%20V5.lua"))()
end)

AlysseBuiltInSection:NewTextBox("Built-In Executor", "execute loadstring", function(built)
	execute = built
end)

AlysseBuiltInSection:NewButton("Execute", "", function()
	loadstring(execute)()
end)

AlysseBuiltInSection:NewLabel("Modify Executors")
AlysseBuiltInSection:NewButton("Remove Codex UI", "", function()
	if game.CoreGui:FindFirstChild("Codex") then
		game.CoreGui:FindFirstChild("Codex"):Destroy()
	end
end)
AlysseBuiltInSection:NewButton("Remove Fluxus UI", "", function()
	if game.CoreGui:FindFirstChild("FluxusAndroidUI") then
		game.CoreGui:FindFirstChild("FluxusAndroidUI"):Destroy()
	end
end)
AlysseBuiltInSection:NewButton("Remove Delta UI", "", function()
	if game.CoreGui:FindFirstChild("Delta") then
		game.CoreGui:FindFirstChild("Delta"):Destroy()
	end

	if game.CoreGui:FindFirstChild("DeltaIcon") then
		game.CoreGui:FindFirstChild("DeltaIcon"):Destroy()
	end
end)
AlysseBuiltInSection:NewLabel("Executor UI")
AlysseBuiltInSection:NewButton("Load Krypton UI", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/anyahubs/executer/main/Krypton(UI).txt"))()
end)

AlysseBuiltInSection:NewButton("Load Old Delta UI", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/NathTheDev/Project/main/actual_ui.lua"))()
end)

AlysseBuiltInSection:NewButton("Load Arceus X UI", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/AZYsGithub/chillz-workshop/main/Arceus%20X%20V3"))()
end)


AlysseUniversalSection:NewButton("Bloody Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/BloodyHax/Bloody-Hub-Universal/main/Universal%20Bloody", true))()
end)

AlysseUniversalSection:NewButton("Aimbot & ESP", "", function()
	loadstring(game:HttpGet"https://gitlab.com/te4224/Scripts/-/raw/main/Universal%20Aimbot%20N%20Esp/v2/main.lua")();
end)

AlysseUniversalSection:NewButton("Owl Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/CriShoux/OwlHub/master/OwlHub.txt"))();
end)

AlysseUniversalSection:NewButton("Splash", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/voiddscripts/splash/main/universal.lua"))()
end)

AlysseUniversalSection:NewButton("Kyanite Hub", "", function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/NekoMe0w/KyaniteHub/main/loader.lua", true))()
end)

AlysseUniversalSection:NewButton("Project Evolution V4", "", function()
	loadstring(game:HttpGet("https://projectevo.xyz/v4/script.lua", true))();
end)

AlysseHomeButton:NewLabel("Player Name : "..plr.Name.."")
AlysseHomeButton:NewLabel("User Id : "..plr.UserId.."")
AlysseHomeButton:NewLabel("Game Name : "..gameName.."")
AlysseHomeButton:NewLabel("Executor : "..identifyexecutor().."")
AlysseHomeButton:NewLabel("Game Id : "..game.GameId.."")
AlysseHomeButton:NewLabel("Player Count : "..GetPlrs().."")
AlysseHomeButton:NewLabel("Ping : "..ping.."")
AlysseHomeButton:NewLabel("Change Icon Shape")
AlysseHomeButton:NewDropdown("Change Shape", "Change the icon shape", {"Default", "Circle"}, function(iconshape)
	if iconshape == "Default" then
		G2L["1f"]["CornerRadius"] = UDim.new(0, 5);        
	else if iconshape == "Circle" then
			G2L["1f"]["CornerRadius"] = UDim.new(0.50000000298023224, 0);
			writefile("iconshape", "Circle")
		end
	end
end)

AlysseHomeButton:NewLabel("Send Feedback!")
AlysseHomeButton:NewTextBox("Feedback", "", function(fb)
	local webh = "https://discord.com/api/webhooks/1161670416960602243/dKsKKSxLMVFxyapp-2ik1fZrcDvWDFqcOBeRDqLAWfPjaapNXq2YBO69ASGoKpNJqIpx"
	pcall(function()
		local deviceType = ""
...
AlysseHomeButton:NewTextBox("Bug Reports", "", function(br)
	local webh = "https://discord.com/api/webhooks/1161670416960602243/dKsKKSxLMVFxyapp-2ik1fZrcDvWDFqcOBeRDqLAWfPjaapNXq2YBO69ASGoKpNJqIpx"
	pcall(function()
		local deviceType = ""
		...
		local data = {
			['embeds'] = {
				{
					['title'] = 'Alysse Bug Report',
					['description'] = 'Bugs',
					['fields'] = {
						{name = 'User', value = game:GetService("Players").LocalPlayer.Name .. " (ID: " .. game:GetService("Players").LocalPlayer.UserId .. ")"},
						{name = "Problem :", value = br},
						{name = "Game Name", value = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name},
						{name = "Version", value = "0.3"}
					}
				}
...
AlysseUpdateSection:NewLabel("[+] Version Changed from V0.2 to V0.3!")
AlysseUpdateSection:NewLabel("[+] Added More Scripts")
AlysseUpdateSection:NewLabel("[+] Fixed Toggle Icon not showing")
AlysseUpdateSection:NewLabel("[+] Added Executor's UI")
AlysseUpdateSection:NewLabel("[+] Added Modify Executor")
AlysseUpdateSection:NewLabel("[+] Load executors UI now work!")
AlysseUpdateSection:NewLabel("[-] Removed FE Scripts")
AlysseUpdateSection:NewLabel("[-] Removed HWID")



AlysseInformation:NewLabel("Alysse is an executor for mobile device!")
AlysseInformation:NewLabel("This script is just part of our project!")
AlysseInformation:NewLabel("Script former name : Gamebreaker")
AlysseInformation:NewLabel("Owner : nathanxd_1")
AlysseInformation:NewButton("Copy Discord Link", "Copy Discord Link", function()
	setclipboard("https://discord.gg/yXqRWcVEW3")
end)

AlysseBuiltInSection:NewButton("Load Codex UI", "", function()
...
AlysseBuiltInSection:NewButton("Load Kiwi X UI", "", function()
    --[[ Settings ]]--
